    ...
    <div className="relative min-h-screen pt-12">
      ...
      <main className="relative z-10 flex flex-col items-center w-full">
            ...
            <div className="flex flex-col-reverse md:flex-row gap-10 items-center">
              ...
              <motion.div
                ...
                <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-white/20 dark:border-white/10">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-white/65 dark:bg-gray-900/60 backdrop-blur-md p-4 rounded-xl shadow-lg border border-white/40 dark:border-white/10">
                    <div className="flex items-center gap-3">
                      <div className="bg-green-500/20 text-green-700 dark:text-green-400 p-2 rounded-full">
        ...
        <section className="w-full px-4 md:px-10 py-16 flex justify-center relative">
          <div className="absolute inset-0 bg-white/30 dark:bg-gray-800/30 skew-y-3 transform origin-top-left -z-10" />
          <div className="max-w-[1120px] w-full">
            <motion.div
              initial="hidden"
              whileInView="visible"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <motion.div
                  ...
                  <div className="relative z-10 flex flex-col gap-6 h-full">
                    <div className="w-14 h-14 bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 rounded-xl flex items-center justify-center mb-2">
                ...
                <motion.div
                  ...
                  <div className="relative z-10 flex flex-col gap-6 h-full">
                    <div className="w-14 h-14 bg-purple-100 dark:bg-purple-900/50 text-purple-600 dark:text-purple-400 rounded-xl flex items-center justify-center mb-2">
              ...
              <motion.div
                ...
                {cultureImages.map((image, index) => (
                  <motion.div
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 bg-white/65 dark:bg-gray-900/60 backdrop-blur-md m-2 rounded-lg translate-y-full group-hover:translate-y-0 transition-transform duration-300 border border-white/40 dark:border-white/10">
